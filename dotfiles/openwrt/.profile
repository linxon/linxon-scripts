...
[ -x /usr/bin/htop ] && alias top='/usr/bin/htop' && alias oldtop='/usr/bin/top'
[ -x /usr/bin/curl ] && alias check_rhost="curl -s https://check.torproject.org/api/ip | jsonfilter -e '$.IP'"
